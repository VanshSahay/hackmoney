...
import { P2PNetwork, MessageBuilder } from '../../src/network/p2p.js';
import type { PartyConfig, MessageType, ReplicatedShares } from '../../src/types.js';
...
describe('MessageBuilder', () => {
  ...
  describe('shareDistribution', () => {
    it('should create share distribution message', () => {
      ...
      const message = MessageBuilder.shareDistribution(sessionId, 1, intentId, shares);
  ...
  describe('reconstructionRequest', () => {
    it('should create reconstruction request message', () => {
      ...
      const message = MessageBuilder.reconstructionRequest(sessionId, 1, variable);
